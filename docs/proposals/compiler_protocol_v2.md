...
```json
{"schema":1,"protocols":[1,2],"artifact_formats":[8],"compiler_id":"<64 lowercase hex digits>","standard_library":{"package":"cloth","version":"0.6.0"},"operations":["compile","inspect","link","reuse"],"interface_targets":["x86_64","wasm32"],"object_targets":["x86_64"]}
```
...
Shuttle requires protocol 2 and artifact format 8 for this workflow. A
...
Stage 28.3 requires artifact format 4, compiler ABI 4,
and runtime ABI 2. Format 4 extends scalar constants to the full signed integer
range while retaining the aggregate layouts and precise array reference maps.
