...
```json
{"schema":1,"protocols":[1,2],"artifact_formats":[5],"compiler_id":"<64 lowercase hex digits>","standard_library":{"package":"cloth","version":"0.2.0"},"operations":["compile","inspect","link","reuse"],"interface_targets":["x86_64","wasm32"],"object_targets":["x86_64"]}
```
